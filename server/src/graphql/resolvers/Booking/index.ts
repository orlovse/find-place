...
import { Database, Booking, BookingsIndex, Listing } from "../../../lib/types";
    ...
    Mutation: () => {
        createBooking: async (
            ...
            try {
                ...
                const totalPrice = listing.price * ((checkOutDate.getTime() - checkInDate.getTime()) / MILLISECONDS_IN_DAY + 1);
